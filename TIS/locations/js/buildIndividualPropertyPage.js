function buildIndividualPropertyPage(jsonObj, cityToBuild, classToFind, classToCreate, imagesToDisplay = 0) {
    ...
    for (let i = 0; i < temples.length; i++) {
        if (cityToBuild == temples[i].resourcename) {
            ...
            let _imagePath = "../" + _property.images.path;
