const weatherAPI = 'http://api.openweathermap.org/data/2.5/forecast?id=5604473&APPID=2530a9dd66685fdcc10fc4a2805bd81d&units=imperial';
    ...
    .then((jsonObj) => {
        ...
        for (let x = 0; x < town.length; x++) {
            ...
            if (x == 0) {
                ...
                const iconurl = 'https://openweathermap.org/img/w/' + town[x].weather[x].icon + '.png';
                const icondesc = town[x].weather[x].description;
